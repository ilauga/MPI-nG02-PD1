...
public class  HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        Button btnLogin = view.findViewById(R.id.btnHomeToLogin);
        ...
        Button btnRegister = view.findViewById(R.id.btnHomeToRegister);
        ...
        Button btnServices = view.findViewById(R.id.btnHomeToServices);
